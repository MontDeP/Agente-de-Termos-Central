...
export const systems: SystemData[] = [
  ...
  {
    id: "pronto-portal",
    name: "Pronto! Portal de Serviços",
    category: "servicos",
    categoryLabel: "SERVIÇOS",
    icon: "Globe",
    description:
      "Plataforma oficial para agendamento de atendimentos presenciais em órgãos do Governo do Tocantins e acesso a serviços digitais.",
        ...
        sections: [
          {
            title: "1. Objetivo",
            content:
              "Este Termo de Uso regula o acesso e a utilização do Pronto! Portal de Serviços, plataforma oficial do Governo do Estado do Tocantins para agendamento de atendimentos presenciais e acesso a serviços digitais, em conformidade com o Decreto Estadual nº 6.757, de 5 de março de 2024.",
          },
          {
            title: "2. Aceitação dos Termos",
            content:
              "Ao acessar e utilizar o Pronto! Portal de Serviços, o usuário declara que leu, compreendeu e aceita integralmente as condições estabelecidas neste Termo de Uso.",
          },
          {
            title: "3. Requisitos de Acesso",
            content:
              "O acesso ao portal pode ser realizado por meio de conta Gov.br. O usuário é responsável por manter a confidencialidade de suas credenciais de acesso.",
          },
          {
            title: "4. Obrigações do Usuário",
            content:
              "O usuário se compromete a fornecer informações verdadeiras no cadastro, manter o sigilo de sua senha, utilizar o serviço de forma ética e legal, e comunicar imediatamente qualquer uso não autorizado de sua conta.",
          },
          {
            title: "5. Limitações de Responsabilidade",
            content:
              "A ATI não se responsabiliza por danos causados por má utilização do portal, instabilidades técnicas fora de seu controle ou dados inseridos incorretamente pelo usuário.",
          },
          {
            title: "6. Disposições Gerais",
            content:
              "Estes termos são regidos pelas leis da República Federativa do Brasil. A ATI reserva-se o direito de alterar este Termo de Uso a qualquer momento, mediante publicização da nova versão na plataforma.",
          },
          {
            title: "7. Contato",
            content:
        ...
        sections: [
          {
            title: "1. Introdução",
            content:
              "A ATI valoriza a privacidade dos cidadãos que utilizam o Pronto! Portal de Serviços e se compromete com a proteção dos dados pessoais tratados, em conformidade com a Lei nº 13.709/2018 (LGPD).",
          },
          {
            title: "2. Dados Coletados",
            content:
              "Para a prestação dos serviços de agendamento, coletamos: nome completo, CPF, e-mail, telefone e dados de navegação. A coleta é limitada ao mínimo necessário para a finalidade do serviço.",
          },
          {
            title: "3. Finalidade do Tratamento",
            content:
              "Os dados são tratados para: agendamento de atendimentos presenciais, prestação de serviços digitais ao cidadão, e cumprimento de obrigações legais.",
          },
          {
            title: "4. Base Legal",
            content:
              "O tratamento fundamenta-se no cumprimento de obrigação legal e execução de políticas públicas, conforme incisos I e IV do art. 7º da LGPD.",
          },
          {
            title: "5. Compartilhamento de Dados",
            content:
              "Os dados podem ser compartilhados com órgãos públicos estaduais quando necessário para execução dos serviços solicitados. Não vendemos nem comercializamos dados pessoais.",
          },
          {
            title: "6. Segurança",
            content:
              "Adotamos criptografia em repouso e em trânsito, controle de acesso individual e registros de auditoria para proteger seus dados.",
          },
          {
            title: "7. Direitos do Titular",
            content:
              "Você pode solicitar acesso, correção, portabilidade ou eliminação dos seus dados entrando em contato pelo e-mail contato@ati.to.gov.br.",
          },
        ],
      },
    },
  ...
  {
    id: "cax",
    name: "Central de Ajuda (CAx)",
    category: "servicos",
    categoryLabel: "SERVIÇOS",
    icon: "MessageCircle",
    description:
      "Sistema de gestão e acompanhamento de chamados técnicos e solicitações de suporte em TI.",
        ...
        sections: [
          {
            title: "1. Objetivo",
            content:
              "Este Termo de Uso regula o acesso e a utilização da Central de Ajuda (CAx), sistema de gestão de chamados técnicos e suporte em TI da ATI Tocantins.",
          },
          {
            title: "2. Aceitação dos Termos",
            content:
              "Ao utilizar o CAx, o usuário declara ter lido e aceito integralmente as condições deste Termo de Uso.",
          },
          {
            title: "3. Uso do Sistema",
            content:
              "O CAx destina-se exclusivamente ao registro, acompanhamento e resolução de chamados técnicos por servidores e colaboradores autorizados. O uso para fins pessoais ou não relacionados ao serviço público é vedado.",
          },
          {
            title: "4. Obrigações do Usuário",
            content:
              "O usuário deve descrever os chamados com precisão, manter sigilo sobre informações de terceiros acessadas durante o suporte, e não utilizar o sistema para fins não autorizados.",
          },
          {
            title: "5. Limitações de Responsabilidade",
            content:
              "A ATI não se responsabiliza por prazos de resolução impactados por informações incompletas fornecidas pelo solicitante.",
          },
          {
            title: "6. Disposições Gerais",
            content:
              "A ATI reserva-se o direito de alterar este Termo de Uso a qualquer momento. O uso continuado do sistema constitui aceitação dos novos termos.",
          },
          {
            title: "7. Contato",
            content:
              "Para dúvidas sobre este Termo, entre em contato pelo e-mail contato@ati.to.gov.br ou pelo telefone (63) 3212-4500.",
          },
        ],
      },
      privacy: {
  ...
  {
    id: "ficha-hospedes",
    name: "Ficha Nacional de Registro de Hóspedes",
